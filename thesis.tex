...
\begin{document}
	...
	\input{tex/cbla}\newpage\cleardoublepage
	\input{tex/interactive_control_system}\newpage\cleardoublepage
	\input{tex/validations}\newpage\cleardoublepage
	\input{tex/conclusions_future_work}\newpage\cleardoublepage
	...
	\chapter{Design of the Control Module}\label{Append:Control Module}
	\input{tex/control_module}\newpage\cleardoublepage
	
	\chapter{Design of the Data Logging Module}\label{Append:Data Logging}
	\input{tex/data_logging}\newpage\cleardoublepage
	
	\chapter{Design of the Device Nodes}\label{Append:Device Nodes}
	\input{tex/device_nodes}\newpage\cleardoublepage
