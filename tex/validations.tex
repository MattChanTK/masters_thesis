...
\begin{figure} [!htbp]
	\centering
	\fbox{\includegraphics[height=0.40\textheight]{"fig/validations/Questionaire-Card2"}}
...
\begin{enumerate}
	...
	\item CBLA Mode vs. Prescripted Mode: on during first half
		\begin{itemize}[align=left]
			...
			\end{itemize}
		\end{itemize}
	\item CBLA Mode vs. Prescripted Mode: on during second half
		\begin{itemize}[align=left]
